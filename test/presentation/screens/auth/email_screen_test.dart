...
void main() {
  testWidgets('EmailScreen enables continue button when email is valid', (tester) async {
    ...
    // Check for inputs
    expect(find.byType(TextField), findsOneWidget); // CustomInput contains a TextField
  ...
  testWidgets('EmailScreen shows error snackbar on FirebaseAuthException', (tester) async {
    ...
    await tester.enterText(find.byType(TextField), errorEmail);
    await tester.pump(); // Validation update
